...
class TooltipTextDrawable extends Drawable {
    ...
    TooltipTextDrawable(final Context context, final Tooltip.Builder builder) {
    ...
    void setAnchor(final Tooltip.Gravity gravity, int padding, @Nullable Point point) {
    ...
    private void calculatePath(Rect outBounds) {
        ...
        final float maxX = right;
        final float minY = top + ellipseSize;
        final float minX = left;
    ...
    private void calculatePathWithGravity(
            final Rect outBounds, final int left, final int top, final int right, final int bottom, final float maxY,
            final float maxX,
        ...
        setTopLeftRigth(outBounds, left, top, right, bottom, drawPoint);
        setBottomLeftRigth(outBounds, left, top, right, bottom, drawPoint);
    ...
    private void setTopLeftRigth(final Rect outBounds, final int left, final int top, final int right, final int bottom,
                                 boolean drawPoint) {
    ...
    private void setBottomLeftRigth(final Rect outBounds, final int left, final int top, final int right, final int bottom,
                                    boolean drawPoint) {
        // bottom/right
    ...
    private static boolean isDrawPoint(
            final int left, final int top, final int right, final int bottom, final float maxY, final float maxX,
            final float minY,
        ...
        if (gravity == Tooltip.Gravity.RIGHT || gravity == Tooltip.Gravity.LEFT && tmpPoint.y >= top && tmpPoint.y <= bottom) {
            ...
            drawPoint = setDrawPoint(left, right, maxX, minX, tmpPoint, arrowWeight, false);
        }
        return drawPoint;
    }

    private static boolean setDrawPoint(final int left, final int right, final float maxX, final float minX, final Point tmpPoint,
                                        final int arrowWeight, boolean drawPoint) {
        if (tmpPoint.x >= left && tmpPoint.x <= right && tmpPoint.x >= left && tmpPoint.x <= right) {
    ...
    @Override
    public void setColorFilter(final ColorFilter cf) { /*unused*/ }
